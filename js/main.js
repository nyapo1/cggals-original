    ...
    <a href="profile.html?name=${encodeURIComponent(member.name)}&imgSrc=${encodeURIComponent(member.imgSrc)}&description=${encodeURIComponent(member.description)}&age=${encodeURIComponent(member.Age)}&state=${encodeURIComponent(member.Location.State)}&city=${encodeURIComponent(member.Location.City)}&phoneNumber=${encodeURIComponent(member.phoneNumber)}&username=${encodeURIComponent(member.username)}" class="row mx-1 text-decoration-none bg-dark rounded p-3">
        ...
        <div class="col-md-5 mx-auto ">
            ...
            <div class="col-sm-12 d-flex justify-content-center input-group my-2">
                ...
                <input  id="state" value="${member.Location.State}" class="form-control form-control-lg " >
            </div>
            ...
            <div class="col-sm-12 d-flex justify-content-center input-group my-2">
                ...
                <input  id="City" value="${member.Location.City}" class="form-control form-control-lg " >
            </div>
        </div>
    </a>
  `;
...
function displayCities(state) {
    ...
    // Scroll to the city selection area
